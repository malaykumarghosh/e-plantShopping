...
function ProductList({ onHomeClick }) {
    ...
    const cart_count = cartItems.reduce((total, item) => total + item.quantity, 0);
    ...
    const handleAddToCart = (plant) => {
        ...
        setAddedToCart((prevState) => ({ // Update the local state to reflect that the product/plant has been added
            ...prevState, // Spread the previous state to retain existing entries
            [plant.name]: true, // Set the current product's/plant's name as a key with value 'true' to mark it as added
        }));
    };
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <text id="cart-count" x="125" y="150" text-anchor="middle" font-size="60" fill="white">{cart_count}</text>
                    </svg></h1></a></div>
                </div>
            </div>
            {!showCart ? (
                <div className="product-grid">
                    ...
                    <div key={index}> {/* Unique key for each category div */}
                        <h1>
                        <div className='plantname_heading'><div className='plant_heading'>{category.category}</div></div> {/* Display the category name */}
                        </h1>
